...
type OutreachEmail = { subject: string; body: string };
...
const OutreachModal: React.FC<OutreachModalProps> = ({ jobDescription, candidate, onClose, isDemo }) => {
    const [emailContent, setEmailContent] = useState<OutreachEmail | null>(null);
    ...
    useEffect(() => {
        const fetchEmail = async () => {
            ...
            try {
                ...
                setEmailContent(content as OutreachEmail);
            } catch (error) {
