...
for (const pattern of required) {
  if (!pattern.test(migration)) throw new Error(`Hiring state tenant integrity guard missing: ${pattern}`);
}

console.log('Hiring state tenant integrity migration contract verified');
