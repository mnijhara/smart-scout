...
if(container){const root=createRoot(container);const path=window.location.pathname.replace(/\/$/,'')||'/';const publicHome=<><LandingPageFinal onStart={()=>window.location.assign('/hire')}/><ByokWidget/></>;const lifecycle=<AuthGate><HiringLifecycleV2 onBack={()=>window.location.assign('/')}/></AuthGate>;const view=path==='/old'?<App/>:path==='/hire'?lifecycle:publicHome;root.render(<React.StrictMode>{view}</React.StrictMode>)}
