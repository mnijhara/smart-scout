...
import App from './App';
import HiringLifecycleV4 from './components/HiringLifecycleV4';
...
if (container) {
  ...
  const lifecycle = <AuthGate><><JDImportBridge /><HiringLifecycleV4 onBack={() => window.location.assign('/')} /></></AuthGate>;
